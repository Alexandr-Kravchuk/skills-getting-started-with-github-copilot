...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training sessions and inter-school meets",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, improvisation, and stage productions",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["amelia@mergington.edu", "elijah@mergington.edu"]
    },
    "Mathletes": {
        "description": "Competitive math problem solving and team challenges",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "harper@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Hands-on science experiments and academic competitions",
